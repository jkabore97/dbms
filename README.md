...
To bring a database anywhere between `005` and `066` up to date, paste
`database/apply_006_to_066.sql` into the Supabase SQL editor and run it once.
It is `006` through `066` concatenated inside one transaction, so it either
